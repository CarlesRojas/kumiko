...
export const Route = createFileRoute("/$language/_public/legal/privacy-policy/")({
        ...
        <main className="relative flex w-full justify-center overflow-y-auto p-4">
            <div className="prose prose-neutral prose-invert max-w-screen-lg pb-20">
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            <strong>Application</strong> refers to Kumiko Create, the software program provided by the
                            Company.
                        </p>
                    </li>
                    <li>
                        <p>
                            ...
                            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Kumiko Create.
                        </p>
                    </li>
                    <li>
                        <p>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to Kumiko Create, accessible from{" "}
                            <a href="https://www.kumikocreate.com" rel="external nofollow noopener" target="_blank">
                                https://www.kumikocreate.com
                            </a>
                        </p>
                    </li>
                    <li>
                ...
                <p>
                    {
                        "Kumiko Create' use and transfer to any other app of information received from Google APIs will adhere to "
                    }
                    <a
                ...
                <ul>
                    <li>By email: kumikocreate@carlesrojas.com</li>
                </ul>
            </div>
        </main>
    );
