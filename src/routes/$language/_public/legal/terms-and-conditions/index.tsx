...
export const Route = createFileRoute("/$language/_public/legal/terms-and-conditions/")({
        ...
        <div className="relative flex size-full justify-center overflow-y-auto p-4">
            <div className="prose prose-neutral prose-invert h-fit max-w-screen-lg pb-10">
                ...
                <p>
                    ...
                    &quot;Application&quot;) for mobile devices that was created by Pinya Apps (hereby referred to as
                ...
                <p>
                    ...
                    they do rely on third parties to provide information to them so that they can make it available to
                    you. The Service Provider accepts no liability for any loss, direct or indirect, that you experience
